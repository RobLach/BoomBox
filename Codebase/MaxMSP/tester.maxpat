	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"id" : "obj-21",
					"patching_rect" : [ 919.0, 377.0, 50.0, 20.0 ],
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "//otheravatar:id=123456&class=C&patternNumber=1&position=-2|4&distance=4.47&instrument=2",
					"linecount" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-15",
					"patching_rect" : [ 345.0, 495.0, 493.0, 32.0 ],
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sprintf //otheravatar:id=%ld&class=C&patternNumber=%ld&position=%ld|%ld&distance=%.2f&instrument=%ld",
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-10",
					"patching_rect" : [ 343.0, 415.0, 594.0, 20.0 ],
					"fontname" : "Arial",
					"numinlets" : 6
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"patching_rect" : [ 660.0, 28.0, 200.0, 200.0 ],
					"local" : 0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "//myavatar:class=B&patternNumber=2&instrument=2",
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-7",
					"patching_rect" : [ 27.0, 62.0, 282.0, 18.0 ],
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "//myavatar:class=B&patternNumber=1&instrument=1//otheravatar:id=987654&class=D&patternNumber=2&position=-3|2&distance=3.6&instrument=1//otheravatar:id=123456&class=C&patternNumber=1&position=1|4&distance=4.1&instrument=2//otheravatar:id=654321&class=L&patternNumber=2&position=3|4&distance=5&instrument=3",
					"linecount" : 3,
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"id" : "obj-5",
					"patching_rect" : [ 47.0, 90.0, 601.0, 44.0 ],
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 719.5, 366.0, 816.0, 366.0, 816.0, 408.0, 697.5, 408.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 611.5, 407.0, 812.5, 407.0 ]
				}
