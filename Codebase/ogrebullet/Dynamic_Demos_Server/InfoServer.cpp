// InfoServer.cpp : Defines the entry point for the console application.
//
...
void Server::ZCom_cbZoidResult(ZCom_ConnID _id, eZCom_ZoidResult _result, zU8 _new_level, ZCom_BitStream &_reason)
{
	...
	cout << "Server: Creating node for client to play with now..." << endl;
	...
	av->ownerID = _id;
	ZCom_setUserData(_id, (void*) _id);
	cout << "Server: inserted node for: " << (int)_id << endl;
	//    break;
	//  }
	//}*/
}
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	Player::registerClass(srv);
	cout << "Registering Player object..." << endl;
	Player* player = new Player(srv);

	//// create a tree
	//Avatar *avatar = new Avatar(srv, true);
