...
void OgreBulletListener::setPhysicGUI()
{
	...
	//GameGUI * gameGUI = new GameGUI(mWindow, mSceneMgr);
    ...
    /*aWindow = menuWindow->addMenuWindowTab("Choose Team");
	aWindow->addBoolButton(&mTeam1, "Team 1", BetaGUI::WPT_HORIZONTAL);
    aWindow->addBoolButton(&mTeam2, "Team 2", BetaGUI::WPT_HORIZONTAL);
	if(mTeam1 == true)
		aWindow->addStaticText("You are Part of Team One",BetaGUI::WPT_VERTICAL);
	else if(mTeam2 == true)
		aWindow->addStaticText("You are Part of Team Two",BetaGUI::WPT_VERTICAL);
	aWindow->hide();
...
//// -------------------------------------------------------------------------
//void OgreBulletListener::setBoomBoxGUI()
//{
//    BetaGUI::GUI *gui = mGuiListener->getGui ();
//
//    BetaGUI::Window *menuWindow = gui->addMenuWindow(
                                                ...
                                                bool castShadow)
{
	...
	sceneEntity->setMaterialName(instanceName);
    ...
    sceneRigid->setStaticShape(node, sceneTriMeshShape, bodyRestitution, bodyFriction, pos,q);
...
//			tris + StringConverter::toString(stats.triangleCount) + " / */ "Team Members: " + playerNames.front()
//            );
//		}
//		else
//		{
...
//            /*avgFps + StringConverter::toString(stats.avgFPS) + " / " +
//            currFps + StringConverter::toString(stats.lastFPS) + " / " +
//			tris + StringConverter::toString(stats.triangleCount) + " / */ "Team Members: "
//            );
//		}
//    }
//
