...
#include "CEGUIXMLAttributes.h"
 ...
 GameMenu::GameMenu(Ogre::RenderWindow *extWindow, Ogre::SceneManager *extSceneMgr)
{
...
void GameMenu::setImageset(char * imageset)
{
    CEGUI::ImagesetManager::getSingletonPtr()->createImageset(imageset);
}

bool GameMenu::keyPressed(const CEGUI::EventArgs &e)
{
...
bool GameMenu::keyUp(const CEGUI::EventArgs &e)
{
    const CEGUI::KeyEventArgs& key = static_cast<const CEGUI::KeyEventArgs&>(e);
    if (key.scancode == CEGUI::Key::Tab)
    {
...
bool GameMenu::buttonClicked(const CEGUI::EventArgs &e)
{
    return true;
}

bool GameMenu::mouseMove(const CEGUI::EventArgs &e)
{
    return true;
}

bool GameMenu::onTextChanged(const CEGUI::EventArgs &e)
{
